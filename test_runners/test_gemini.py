#!/usr/bin/env python3
"""
Gemini model test runner for conversation analysis
Tests all conversation types using Google Gemini API
"""
...
class GeminiTestRunner:
    ...
    def test_single_type(self, test_type: str, max_conversations: int = None) -> str:
        ...
        print(f"🧪 Running {test_type} test with Gemini...")
    ...
    def test_all_types(self, max_conversations: int = None) -> Dict[str, str]:
        ...
        print("🚀 Running ALL conversation tests with Gemini")
        print("=" * 60)
        ...
        for test_type in ASSESSMENT_PROMPTS.keys():
            print(f"\n{'='*50}")
            print(f"Testing {test_type.upper()} with Gemini")
            print(f"{'='*50}")
    ...
    def run_interactive(self):
        ...
        print("🧠 Gemini Model Test Runner")
        print("=" * 40)
        ...
        while True:
            ...
            try:
                ...
                if choice == '1':
                    ...
                    print(f"\n{'='*60}")
                    print(f"🎯 ALL GEMINI TESTS COMPLETED!")
                    print(f"⏱️  Total time: {end_time - start_time}")
                    print(f"📁 Results saved in: results/gemini/")
                    print(f"{'='*60}")
                    break
